...
import { createSNSAccount } from "../graphql/mutations";
const client = generateClient();
export default function SNSAccountCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAutoPost(initialValues.autoPost);
    setAutoGenerate(initialValues.autoGenerate);
    setAutoReply(initialValues.autoReply);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSNSAccount.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SNSAccountCreateForm")}
      {...rest}
    >
      <TextField
        label="Platform"
